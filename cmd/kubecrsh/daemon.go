...
func runDaemon(cmd *cobra.Command, args []string) error {
	...
	daemonCfg := daemon.Config{
		...
		HTTPAddr:          httpAddr,
		CrashWorkers:      cfg.Performance.CrashWorkers,
		CrashQueueSize:    cfg.Performance.CrashQueueSize,
		NotifierWorkers:   cfg.Performance.NotifierWorkers,
		NotifierQueueSize: cfg.Performance.NotifierQueueSize,
		Notifiers:         notifiers,
		Storage:           storage,
